...
class PdfController extends Controller
{
    ...
    public function convert_orders_data_to_html(){
        ...
        $output = '<link rel="stylesheet" href="include/css/style1.css">
            <table class="table">
                <thead class="thead">
                    <tr class="text-left">
                    ...
                    foreach($orders as $order){
                        ...
                        foreach($order->cart->items as $item){
                            ...
                            $output .= '<tr class="text-center">
                                        <td class="image-prod"><img src="storage/products_img/'.$item['product_image'].'" alt="" style = "height: 80px; width: 80px;"></td>
